...
exports.default = function (_ref) {
    ...
    _fs2.default.readFile(filepath, 'utf8', function (err, data) {
        ...
        var categories = (0, _pipeWith2.default)(new _taskfile2.default(data).sumByCategory(), (0, _filter2.default)((0, _get2.default)('category')), (0, _filter2.default)(function (_) {
        ...
        (0, _pipeWith2.default)(categories, (0, _forEach2.default)(function (cat) {
            ...
            var categoryString = '| ' + category + categoryPad + ' | ' + percentPad + percent + '% | ' + hoursPad + hours + ' hrs | ' + bar;
