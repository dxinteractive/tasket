...
var Taskfile = function () {
    function Taskfile(input) {
        ...
        this._tasks = (0, _pipeWith2.default)(input.split("##"), (0, _map2.default)(function (day) {
            var split = day.split("\n");
            var date = split[0];
            ...
            return (0, _pipeWith2.default)(split, (0, _filter2.default)(function (line) {
                ...
                var grouped = (0, _pipeWith2.default)(tasks, (0, _groupBy2.default)((0, _get2.default)('category')));
    ...
    (0, _createClass3.default)(Taskfile, [{
        key: 'from',
        value: function from(fromDate) {
            if (!fromDate) {
                return this;
            }
            return new Taskfile(this._tasks.filter(function (task) {
                return task.dateNumber >= Taskfile.numberifyDate(fromDate);
            }));
        }
    }, {
        key: 'to',
        value: function to(toDate) {
            if (!toDate) {
                return this;
            }
            return new Taskfile(this._tasks.filter(function (task) {
                return task.dateNumber < Taskfile.numberifyDate(toDate);
            }));
        }
    }, {
        key: 'groupByCategory',
        value: function groupByCategory() {
            return (0, _pipeWith2.default)(this._tasks, (0, _groupBy2.default)((0, _get2.default)('category')), (0, _toArray5.default)());
        }
    }, {
        key: 'sumByCategory',
        value: function sumByCategory() {
            ...
            return (0, _pipeWith2.default)(this.groupByCategory(), (0, _map2.default)(function (tasks) {
        ...
        key: 'workTasks',
        get: function get() {
            return this._tasks.filter(function (_) {
...
Taskfile.nonWorkCategories = ['start', 'lunch', 'coffee'];
